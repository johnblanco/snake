  ...
  var levels = [
    ...
    */                                  //nivel 2
    new Level([                      //obstaculos
      ...
      new Obstacle(new Vector(2, 55), 230, 2),
      new Obstacle(new Vector(240, 47), 2, 158),
      new Obstacle(new Vector(230, 57), 2, 158),
      new Obstacle(new Vector(242,203 ),20 ,2 ),
      new Obstacle(new Vector(232,213 ),30 ,2 ),
      new Obstacle(new Vector(262,194 ), 2,11 ),
      new Obstacle(new Vector(262,213 ),2 ,11 ),
